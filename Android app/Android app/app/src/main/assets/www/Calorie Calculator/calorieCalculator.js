...
function captureUserInfo(){
    ...
    if (height <= 0 || isNaN(height)){
        Android.showToast("Error: Invalid height entered. Must be greater than or equal to zero.  Height set to 5 ft. 9 in.");
        height = 81;
        //return;
    }
    ...
    if(weight <= 0){
        Android.showToast("Error: Invalid weight entered. Must be greater than or equal to zero.  Weight set to 155 lbs.");
        weight = 155;
        //return;
    }
    ...
    if(!gender){
        Android.showToast("Error: Couldn't retrieve gender information. Please try again.");
        return;
    }
    
    var activityFactor = document.getElementById("activityFactor").value;
    if(activityFactor < 0 || activityFactor > 100){
        Android.showToast("Error: Couldn't retrieve accurate activityFactor information. Please try again.");
        activityFactor = 50;
        return;
    }
